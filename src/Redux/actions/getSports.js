...
export const getAllSports = () => {
    return async (dispatch) => {
        const recommendedRES = await GET_noToken('/items/status/0/category/3/subCategory/0');
        const trendingNowRES = await GET_noToken('/items/status/1/category/3/subCategory/0');
        const mostWatchedRES = await GET_noToken('/items/status/2/category/3/subCategory/0');
        const newReleasesRES = await GET_noToken('/items/status/3/category/3/subCategory/0');
